    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimePayment", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    TimePaymentId = table.Column<int>(type: "int", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryPayment", x => new { x.BookingId, x.TimePaymentId });
                    table.ForeignKey(
                        name: "FK_HistoryPayment_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistoryPayment_TimePayment_TimePaymentId",
                        column: x => x.TimePaymentId,
                        principalTable: "TimePayment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryPayment_TimePaymentId",
                table: "HistoryPayment",
                column: "TimePaymentId");
